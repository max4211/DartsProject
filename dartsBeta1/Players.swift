...
// Import names from the firebase database
var names = ["Jake", "Max", "Noah", "Geoff", "Griffin", "Mitch", "Zoe", "Whiskey"]
var description = ["Average shooter", "Bullseye king", "Throws like a baseball"]
